var MCASeo = {
    "overview-description": {
      "title" : "The best MCA engineering college in Ghaziabad, Delhi NCR, India",
      "description" : "ABES is the best MCA engineering college among recognized institutes in Ghaziabad, UP and Delhi NCR, India."
    },
    "about-description": {
      "title" : "MCA-about ABES Engineering College Ghaziabad | Ranked 1 Engineering College in AKTU",
      "description" : "To create globally competent MCA engineers capable of working in an interdisciplinary environment, contributing to society through innovation."
    },
    "hod-description": {
      "title" : "MCA-hod-messege ABES Engineering College Ghaziabad | Ranked 1 Engineering College in AKTU",
      "description" : "MCA Engineering has been traditionally thought of as a professional discipline, applying principles from engineering, physics in design and analysis, manufacturing of MCA systems, and the associated transfer and flow of energies."
    },
    "faculty-description": {
      "title" : "MCA Faculty",
      "description" : "MCA Department - Faculty Members best faculty in NCR."
    },
    "infrastructure-description": {
      "title" : "MCA-infrastructure ABES Engineering College Ghaziabad | Ranked 1 Engineering College in AKTU",
      "description" : "MCA Workshop Lab/Manufactring Process Lab Engineering Graphics & Design Lab."
    },
    "achievements-description": {
      "title" : "MCA-achievements ABES Engineering College Ghaziabad | Ranked 1 Engineering College in AKTU",
      "description" : "GATE Rank Holder 2020 ABES Engineering College ."
    },
    "events-description": {
      "title" : "MCA-event ABES Engineering College Ghaziabad | Ranked 1 Engineering College in AKTU",
    ...
    "magazine-description": {
      "title" : "MCA-magazine ABES Engineering College Ghaziabad | Ranked 1 Engineering College in AKTU",
      "description" : "ABES Engineering College MCA 2021"
    },
    "gallery-description": {
      "title" : "MCA-gallery ABES Engineering College Ghaziabad | Ranked 1 Engineering College in AKTU",
      "description" : "Gallery of MCA engineering at ABES Engineering College"
    },
    "publications-description": {
      "title" : "MCA-publication ABES Engineering College Ghaziabad | Ranked 1 Engineering College in AKTU",
      "description" : "MCA Department - Publications ABES Engineering College is one of the best college in NCR."
    },
    "consultancy-description": {
      "title" : "MCA-consultancy ABES Engineering College Ghaziabad | Ranked 1 Engineering College in AKTU",
      "description" : "School of Manufacturing skills,Bhartiya Skill Development University, Jaipur (BSDU)."
    },
    "industry-connect-description": {
      "title" : "MCA-industry-connects ABES Engineering College Ghaziabad | Ranked 1 Engineering College in AKTU",
      "description" : "General Manager and Head of the Department, Diesel Engine ."
    },
    "training-description": {
      "title" : "MCA-training ABES Engineering College Ghaziabad | Ranked 1 Engineering College in AKTU",
    ...
    "tech-society-description": {
      "title" : "MCA-techsociety ABES Engineering College Ghaziabad | Ranked 1 Engineering College in AKTU",
    ...
    "faq-description": {
      "title" : "MCA-department-FAQ ABES Engineering College Ghaziabad | Ranked 1 Engineering College in AKTU",
      "description" : " The department of MCA engineering was established in year 2003."
    }
  }
  ...
  $(document).ready(function () {
    ...
    $(".tab-bar-heading").click(function () {
      ...
      if (MCASeo.hasOwnProperty(target)) {
        document.title = MCASeo[target].title;
        $('meta[name="description"]').attr('content', MCASeo[target].description);
      }
  })});
