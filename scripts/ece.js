var ECESeo = {
    "overview-description": {
      "title" : "The best ECE engineering college in Ghaziabad, Delhi NCR, India",
      "description" : "ABES is the best ECE engineering college among recognized institutes in Ghaziabad, UP and Delhi NCR, India."
    },
    "about-description": {
      "title" : "ECE-about ABES Engineering College Ghaziabad | Ranked 1 Engineering College in AKTU",
      "description" : "To create globally competent ECE engineers capable of working in an interdisciplinary environment, contributing to society through innovation."
    },
    "hod-description": {
      "title" : "ECE-hod-messege ABES Engineering College Ghaziabad | Ranked 1 Engineering College in AKTU",
      "description" : "ECE Engineering has been traditionally thought of as a professional discipline, applying principles from engineering, physics in design and analysis, manufacturing of ECE systems, and the associated transfer and flow of energies."
    },
    "faculty-description": {
      "title" : "ECE Faculty",
      "description" : "ECE Department - Faculty Members best faculty in NCR."
    },
    "infrastructure-description": {
      "title" : "ECE-infrastructure ABES Engineering College Ghaziabad | Ranked 1 Engineering College in AKTU",
      "description" : "ECE Workshop Lab/Manufactring Process Lab Engineering Graphics & Design Lab."
    },
    "achievements-description": {
      "title" : "ECE-achievements ABES Engineering College Ghaziabad | Ranked 1 Engineering College in AKTU",
      "description" : "GATE Rank Holder 2020 ABES Engineering College ."
    },
    "events-description": {
      "title" : "ECE-event ABES Engineering College Ghaziabad | Ranked 1 Engineering College in AKTU",
    ...
    "magazine-description": {
      "title" : "ECE-magazine ABES Engineering College Ghaziabad | Ranked 1 Engineering College in AKTU",
      "description" : "ABES Engineering College ECE 2021"
    },
    "gallery-description": {
      "title" : "ECE-gallery ABES Engineering College Ghaziabad | Ranked 1 Engineering College in AKTU",
      "description" : "Gallery of ECE engineering at ABES Engineering College"
    },
    "publications-description": {
      "title" : "ECE-publication ABES Engineering College Ghaziabad | Ranked 1 Engineering College in AKTU",
      "description" : "ECE Department - Publications ABES Engineering College is one of the best college in NCR."
    },
    "consultancy-description": {
      "title" : "ECE-consultancy ABES Engineering College Ghaziabad | Ranked 1 Engineering College in AKTU",
      "description" : "School of Manufacturing skills,Bhartiya Skill Development University, Jaipur (BSDU)."
    },
    "industry-connect-description": {
      "title" : "ECE-industry-connects ABES Engineering College Ghaziabad | Ranked 1 Engineering College in AKTU",
      "description" : "General Manager and Head of the Department, Diesel Engine ."
    },
    "training-description": {
      "title" : "ECE-training ABES Engineering College Ghaziabad | Ranked 1 Engineering College in AKTU",
    ...
    "tech-society-description": {
      "title" : "ECE-techsociety ABES Engineering College Ghaziabad | Ranked 1 Engineering College in AKTU",
    ...
    "faq-description": {
      "title" : "ECE-department-FAQ ABES Engineering College Ghaziabad | Ranked 1 Engineering College in AKTU",
      "description" : " The department of ECE engineering was established in year 2003."
    }
  }
  ...
  $(document).ready(function () {
    ...
    $(".tab-bar-heading").click(function () {
      ...
      if (ECESeo.hasOwnProperty(target)) {
        document.title = ECESeo[target].title;
        $('meta[name="description"]').attr('content', ECESeo[target].description);
      }
  })});
